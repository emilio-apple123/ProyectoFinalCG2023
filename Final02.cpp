...
/* ----------------  Proyecto Final   -----------*/
/*-----------------    2023-1   ---------------------------*/
/*------------- Garcia Velazquez Christopher, Emilio Lopez Elijure ------*/
...
int main()
{
	...
	Model pinguino("resources/objects/pinguino/cuerpo.obj");
	Model pinguinoalas("resources/objects/pinguino/alas.obj");
	...
	Model ballenaaletas("resources/objects/ballena/aletas.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//Pinguino
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-120.0f, 32.75f, 350.0f));
		...
		model = glm::rotate(model, glm::radians(variableXB), glm::vec3(1.0f, 0.0f, 0.0f));
		staticShader.setMat4("model", model);
		pinguinoalas.Draw(staticShader);
